              ...
              <div class="card-body">
               ...
               <?php  
                  if($this->input->get("act")=="view"){
                    ...
                    $view = [
                      0 => (object)array(
                                  "id_kategori" => $generate_id,
                                  "jenis_aquarium" => "",
                                  "nama_kategori" => "non aquarium",
                                  "keterangan" => "",
                              )
                          ];                  
                          $act = "Simpan";
                  ...
                  if(!empty($view)){
                    ?>
                     <form action="<?=base_url()?>kategori/non_aquarium/<?=$act?>" method="post">
                      <div class="modal-body">
                          <div class="table_isi">
                              <div class="form-group"><label for="inputEstimatedBudget">Nama Kategori</label>
                                  <input name="id_kategori" type="hidden" value="<?=$view[0]->id_kategori ?: $generate_id?>">
                          ...
                          <div class="card-body">
                              <table class="table table-bordered table-striped" id="tables">
                                  <thead>
                                      <tr>
                                          <th style="">NO </th>
                                          <th style="">ID Kategori </th>
                                          <th style="">Nama Aksesoris</th>
...
const action_delete = (id) => {
    ...
    $.ajax({
        url: "<?=base_url()?>kategori/non_aquarium/delete",
        type: "POST",
        data: {
            id:id
        },
